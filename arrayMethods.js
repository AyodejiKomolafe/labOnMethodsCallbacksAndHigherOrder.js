...
// CODE HERE
const postTaxPrices = prices.map((element,index,wholeArray) => Math.round((element * 1.07)*100)/100);
...
// CODE HERE
const totalPopulation = populations.reduce( (prevElement, curElement, curIndex, wholeArray)  =>{
...
// CODE HERE
const ordersMapped = orders.map((element, index, wholeArray) => Math.round((element.price * (element.tax + 1))*100)/100)
// console.log(ordersMapped)

const ordersReduced = ordersMapped.reduce((prevElement,curElement,wholeArray) => {
  return prevElement + curElement;
})
console.log(ordersReduced)
...
// CODE HERE
const bobsFiltered = purchases.filter((element,index,wholeArray) => element.owner === "Bob");
// console.log(bobsFiltered)

const bobsMapped = bobsFiltered.map((element,index,wholeArray) => element.price);
// console.log(bobsMapped);

const bobsTotal = bobsMapped.reduce((prevElement,curElement,curIndex,wholeArray) => {
  return prevElement + curElement;
} );
