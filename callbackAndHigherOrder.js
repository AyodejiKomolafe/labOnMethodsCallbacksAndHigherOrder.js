...
// CODE HERE
function multiply (a,b, sumFunction){
  let answer = a * b
  return sumFunction(answer);
}

// console.log(multiply(4,5,sumFunction))
...
// CODE HERE 
function first(names,callme){
  return callme(names[0]);
}
...
// CODE HERE
function last (names, callme){
  return callme(names[names.length-1]);
}
...
// CODE HERE 
function contains (array,name,callback2){
...
// CODE HERE
// function uniq(array, callback3){
//   let UniqArr = [];
//   for(let i = 0; i < names.length; i++){
//     for(let j = i + 1; j < names.length; j++){
//       if (names[i] === names[j]){
//         return callback3(UniqArr);
//       }
//     }
//   }
// }
function uniq(arr,callback3){
...
// CODE HERE 
function getUserById(userArr,id,callback5){
  let foundUser
